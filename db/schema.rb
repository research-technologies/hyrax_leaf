...
ActiveRecord::Schema.define(version: 20_180_515_084_952) do
  ...
  create_table 'permission_template_accesses', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[permission_template_id agent_id agent_type access], name: 'uk_permission_template_accesses', unique: true
  ...
  create_table 'sipity_agents', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[proxy_for_id proxy_for_type], name: 'sipity_agents_proxy_for', unique: true
  end
  ...
  create_table 'sipity_entity_specific_responsibilities', force: :cascade do |t|
    ...
    t.index %w[workflow_role_id entity_id agent_id], name: 'sipity_entity_specific_responsibilities_aggregate', unique: true
  ...
  create_table 'sipity_notifiable_contexts', force: :cascade do |t|
    ...
    t.index %w[scope_for_notification_id scope_for_notification_type reason_for_notification notification_id], name: 'sipity_notifiable_contexts_concern_surrogate', unique: true
    t.index %w[scope_for_notification_id scope_for_notification_type reason_for_notification], name: 'sipity_notifiable_contexts_concern_context'
    t.index %w[scope_for_notification_id scope_for_notification_type], name: 'sipity_notifiable_contexts_concern'
  end
  ...
  create_table 'sipity_notification_recipients', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[notification_id role_id recipient_strategy], name: 'sipity_notifications_recipients_surrogate'
  ...
  create_table 'sipity_workflow_actions', force: :cascade do |t|
    ...
    t.index %w[workflow_id name], name: 'sipity_workflow_actions_aggregate', unique: true
  ...
  create_table 'sipity_workflow_responsibilities', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[agent_id workflow_role_id], name: 'sipity_workflow_responsibilities_aggregate', unique: true
  end
  ...
  create_table 'sipity_workflow_roles', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[workflow_id role_id], name: 'sipity_workflow_roles_aggregate', unique: true
  end
  ...
  create_table 'sipity_workflow_state_action_permissions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[workflow_role_id workflow_state_action_id], name: 'sipity_workflow_state_action_permissions_aggregate', unique: true
  end
  ...
  create_table 'sipity_workflow_state_actions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[originating_workflow_state_id workflow_action_id], name: 'sipity_workflow_state_actions_aggregate', unique: true
  end
  ...
  create_table 'sipity_workflow_states', force: :cascade do |t|
    ...
    t.index %w[workflow_id name], name: 'sipity_type_state_aggregate', unique: true
  end
  ...
  create_table 'sipity_workflows', force: :cascade do |t|
    ...
    t.index %w[permission_template_id name], name: 'index_sipity_workflows_on_permission_template_and_name', unique: true
  end
